...
$client_secret = 'xxxxxxxx-xxxxxxx-xxxxxxxxxxxxxx';
$redirect_uri = 'http://localhost/test/gmail/callback.php';
$simple_api_key = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';
$max_results = 500;
$auth_code = $_GET["code"];
